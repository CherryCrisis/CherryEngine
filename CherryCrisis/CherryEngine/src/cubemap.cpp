...
Resource::Ref<Cubemap> Cubemap::Create(const char* texturePath, const char* textures[6])
{
    ...
    return Ref<Cubemap>(cubemap);
}

Resource::Ref<Cubemap>Cubemap::Create(const char* cubemapName, const char* textureRight, const char* textureLeft, const char* textureTop, const char* textureBottom, const char* textureFront, const char* textureBack)
{
