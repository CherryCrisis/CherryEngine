...
void SetDarkStyle(ImGuiStyle* dst = 0)
{
    ...
    colors[ImGuiCol_FrameBg] = ImVec4(0.24f, 0.23f, 0.26f, 1.00f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.24f, 0.23f, 0.29f, 1.00f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.56f, 0.56f, 0.58f, 1.00f);
    colors[ImGuiCol_TitleBg] = ImVec4(0.20f, 0.19f, 0.22f, 1.00f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(0.20f, 0.19f, 0.22f, 1.00f);
    colors[ImGuiCol_TitleBgCollapsed] = ImVec4(1.00f, 0.98f, 0.95f, 0.75f);
    colors[ImGuiCol_MenuBarBg] = ImVec4(0.16f, 0.15f, 0.17f, 1.00f);
    colors[ImGuiCol_ScrollbarBg] = ImVec4(0.00f, 0.00f, 0.00f, 1.00f);
    colors[ImGuiCol_ScrollbarGrab] = ImVec4(1.00f, 1.00f, 1.00f, 0.31f);
    ...
    colors[ImGuiCol_Tab] = ImVec4(0.04f, 0.04f, 0.04f, 0.88f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.24f, 0.57f, 0.66f, 0.88f);
    colors[ImGuiCol_TabActive] = ImVec4(0.00f, 0.39f, 0.49f, 0.88f);
    colors[ImGuiCol_TabUnfocused] = ImVec4(0.10f, 0.31f, 0.37f, 0.88f);
    colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.10f, 0.31f, 0.37f, 0.88f);
    colors[ImGuiCol_DockingPreview] = ImVec4(0.24f, 0.57f, 0.66f, 0.88f);
...
void SetLightStyle(ImGuiStyle* dst)
{
    ImGuiStyle* style = dst ? dst : &ImGui::GetStyle();
    ImVec4* colors = style->Colors;
