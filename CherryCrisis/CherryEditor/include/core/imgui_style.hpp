...
void SetDarkStyle(ImGuiStyle* dst = 0)
{
    ...
    colors[ImGuiCol_ChildBg] = ImVec4(0.06f, 0.05f, 0.06f, 1.00f);
    ...
    colors[ImGuiCol_Header] = ImVec4(0.18f, 0.18f, 0.21f, 1.00f);
    ...
    colors[ImGuiCol_Tab] = ImVec4(0.04f, 0.04f, 0.07f, 1.00f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.10f, 0.10f, 0.13f, 1.00f);
    colors[ImGuiCol_TabActive] = ImVec4(0.11f, 0.11f, 0.12f, 1.00f);
